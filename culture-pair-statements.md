# Culture-pair statements (draft C roster)

Working sheet for soft-SF 4X diplomacy flavor. Each directed pair (Speaker → Target) may carry:


| Field             | Meaning                                                                  |
| ----------------- | ------------------------------------------------------------------------ |
| **Belligerent**   | Threat, insult, contempt, cold warning — in the speaker’s voice          |
| **Complimentary** | Praise, respect, fondness, or backhanded admiration — still in character |


**Blank (**`—`**)** = insufficient lore yet; do not invent under pressure. Fill when the histories support it.

Source tone: `conventional-species-history-c.md`. Includes select **abductee** polities where contact lore is already sharp.
...
- Belligerent ≠ always war; Complimentary ≠ alliance.  
- Abductee ↔ parent pairs often out-bite stranger pairs.  
- **Softnight Kin** outbound compliments name a **gentle pastime** of the target.  
- **Inbound to Softnight:** speakers allude to **their own cultural idyll** (“you live what we mean by enough”).
...
- **Belligerent:** “Your society will fracture under the wrath of the ‘chia pets’, you arrogant fools.”  
...
- **Belligerent:** “You napped through grace, bought the liminal with a rock, and smiled while we bled for dusk. Unearned. All of it.”  
...
- **Belligerent:** “Yours is a sick, sick people.  Leg's dont step that far, child.”  
...
Compliments aimed **at Softnight**, spoken as each culture’s own picture of the good life.

### Humans (Sol) → Softnight Kin
...
- **Belligerent:** "What is the point of you?  Do you even hunt?"
...
- **Belligerent:** "Your entire world has told your people you have nothing to say.  Listen to it."
...
- **Belligerent:** “Stop looking at me like that! We farm caps. We are not your shrine.”  
- **Complimentary:** —  
...
- **Belligerent:** "Is your brain overheating, buddy?"
...
- **Belligerent:** "Your brains discovered particles while searching for something of similar size."
...
Fifteen parent cultures. Cell = whether a directed pair has **any** filled line in this file (B / C / both / —).  
Abductee-only pairs are listed above, not in this grid.

Rows = speaker. Columns = target (abbreviated).


| Speaker ↓ \ Target → | Hum | Vey | Sil | Dra | Mor | Hec | Ylt | Uka | Ix  | Pel | Kha | Nuu | Thr | Vae | Ort |
| -------------------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Humans               | ·   | —   | —   | —   | —   | —   | —   | —   | C   | —   | —   | —   | —   | C   | —   |
| Veyri                | —   | ·   | —   | —   | —   | —   | —   | —   | C   | —   | —   | —   | —   | —   | —   |
| Sillin               | —   | —   | ·   | —   | —   | —   | —   | —   | —   | —   | —   | —   | —   | —   | —   |
...
**Key:** `B` = belligerent filled · `C` = complimentary filled · `·` = self · `—` = blank (insufficient lore)

Most of the grid is intentionally empty. Fill from play, not obligation.
...
| Speaker                           | Line                                                                                                                                          |
| --------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| **Tidecloth Compact (Thalass)**   | “Drylander, you invaded a lagoon of kindness. What the hell are you doing?”                                                                   |
| **Rootward Compact (Mycorr)**     | “They feed without metal and harm. You brought both. Spore take your sense.”                                                                  |
...
| **Glass-Barge (Facetflow)**       | “There’s nothing to facet there but joy. Sheathe it. Now.”                                                                                    |
| **Mirror-Alone (Nullspire)**      | “They wanted guests for tea. You arrived as invasion. Leave.”                                                                                 |
| **Crowdwell Seed**                | “People try to *cover* crimes like this. You just tweeted it out. This fails every antecedent of a just action. What the hell are you doing?” |
| **Sunspill Farms (Glarecap)**     | “They wake in the dusk we tow umbrellas to taste — and you invaded it. What the hell are you doing?”                                          |
| **Rail-Spore (Schedulecap)**      | “This was not on any timetable. Cancel the war. What the hell are you doing?”                                                                 |
| **Highsteppe Remnant (Windscar)** | “Small wars we understand. This one is just ugly. Stop.”                                                                                      |
| **Quiet Banner (Stillsteppe)**    | “…No. Whisper that order back into silence. What are you doing?”                                                                              |
...
| **Herd-Mirror (Driftpair)**       | “Calves at rest. You brought thunder. Why.”                                                                                                   |
| **Shallow-Tone (Brightwell)**     | “Puddle-deep cruelty. What the hell are you doing?”                                                                                           |
| **Dry-Chime (Windshaft)**         | “Wrong wind. Entirely wrong wind. What the hell are you doing?”                                                                               |
| **Nearskin (Closeglen)**          | “After a flare, the sky is kind. You made a new scourge. Stop.”                                                                               |
| **Hidebound (Noavatar)**          | “Ordinary peace is hard enough. You don’t get to break theirs. What the hell are you doing?”                                                  |
| **Brightstep / Neverdark**        | “And people call us resentful.”                                                                                                               |
| **Softnight Kin (defenders)**     | “Izzy would nap first. Also: please stop invading? The animals are confused.”                                                                 |


**If Milknight falls entirely** — Softnight galaxy-wide parting broadcast:

> “To sleep: perchance to dream: ay, there’s the ray.”
...
Two flavors of “we’re helping.” Triggered by situation, not player request.

### Humanitarian aid — peaceful-nice

**Trigger:** One of your **highly populated worlds** is heavily damaged (disaster, bombardment aftermath, plague, ecological collapse). Speakers below send relief — food, seals, med, rebuild crews — and say something in character.


| Speaker                     | Line                                                                                                               |
| --------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| **Softnight Kin**           | “We’re bringing berths, broth, and quiet. Izzy keep your wounded. The animals packed snacks.”                      |
| **Brand-Pack**              | “We know what a broken dens looks like. Shipments are unmarked except for care. No hymns. No hunts. Just help.”    |
| **Soft-Lattice Ix**         | “Your crust — or your cities — need graft. We send growth-crews, not lectures. Lewis is not on this flight.”       |
| **Ylth Swarm-Kin**          | “Starter cultures, shade-cloth, compost heat. A metro that cannot feed is everyone’s problem. Cap-houses open.”    |
| **Crowdwell Seed**          | “Emergency jurisdiction attached. Relief precedes inquiry. File the war later; drink the water now.”               |
| **Hecate Line**             | “We prefer distance. Today distance includes a supply drone and no visitors. Use both.”                            |
| **Nuun Mirror-Polities**    | “Aid in matched pairs — two holds, two manifests, two exits. Imbalance helps no one.”                              |
| **Moru Binders**            | “Cables, seals, bridge-kits. We’ll retie what broke. Toll deferred.”                                               |
| **Drannock Clades**         | “Field-gins and survey stakes for the rubble. Fair plots again when you can stand. No duel-charges in the crates.” |
| **Sillin Chorus-Weavers**   | “Mesh, dye-filters, quiet color for field hospitals. Insult season postponed.”                                     |
| **Rootward Compact**        | “Spore-arks of edible mat and clean air. Metal-light as we can make it. Grow first.”                               |
| **Moss-Dent (Softbite)**    | “Fiber, dew-catch, soft shelters. We tend. You rest.”                                                              |
| **Sunspill Farms**          | “Shade-arks inbound. If the sky is the wound, we know that weather.”                                               |
| **Quiet Banner**            | “Silent drops. No parade. Cloth for bandages, not banners.”                                                        |
| **Vael of the Second Skin** | “Pressure-mains kits, sailcloth shelters, spare skins for search. Watershed rules: help flows downhill.”           |
| **Threnn Bell-Divers**      | “Rim-crews and sounding gear — if the damage is deep, we listen before we dig.”                                    |
| **Orth (parent)**           | “Clinic teams and terrace seed. They meant no war on your civilians. Neither do we.”                               |
...
#### Cooperative / “nice enough”

Still balance-of-power logic, but they’ll coordinate with you.


| Speaker                      | Line                                                                                                                                 |
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| **Humans (Sol)**             | “We understand — right now you need ammo, not a ride. Shipments inbound.”                                                            |
| **Orth of the Brief Dark**   | “Home systems falling makes bad physics and worse neighbors. Interval-peens and step-squads en route. Balance first. Debts later.”   |
| **Nearskin / Closeglen**     | “Flare-season doctrine: you don’t let a scourge write the map. We’ll run charge-nets on your gates — call targets, we’ll burn them.” |
...
They are not shipping crates for you to use. **Their people** take the engagement. Tone: condescension, contempt, or “stay out of our way.”


| Speaker                    | Line                                                                                                                |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| **Veyri of Keth-Orum**     | “Our packs are already on your gates. Real teeth, not proxies. Stay behind the dens and try not to spoil the kill.” |
| **Brazen Ukari**           | “Our hosts are landing. The feed is ours. Wave a flag if you must — then get clear of the shot.”                    |
| **Khar Dentate**           | “We are hunting your invaders. Kill-compass is lit. Do not step into our flense — stay out of our way.”             |
| **Second Pack (Coldfold)** | “Ice dens on your ice. Frost-charges are ours to throw. Trail behind or freeze. Prefer behind.”                     |
| **Highsteppe Remnant**     | “Our bands raid the invaders. Small war, done properly. You hold the camp and don’t trip us.”                       |
| **Spectacle Hex**          | “We’re putting fighters in the pit — your system is the arena. Cheer quietly. Do not enter the circle.”             |
| **Flense-Shore**           | “We kill because we must. Today ‘must’ is your invaders. Bone-flash is in our hands.”                               |
| **Echo-Nation**            | “Our chorus takes the airspace. Mute your claims until we’re done. Stay out of the resonance.”                      |
| **Glass-Barge**            | “Shard cutters are already cutting. Trade route stays open because *we* are on it. Don’t facet in our lane.”        |
| **Market Lattice**         | “Our privateers are voiding the invasion in person. Aisle closed to amateur filings. Stay out of our way.”          |
| **Dry-Chime**              | “Gust-wings over your suns. Wrong wind ends when we say. Ground yourself and watch.”                                |


**Note:** Softnight, Brand-Pack, Ix, and Crowdwell may still *approve* of defensive wars in extreme cases, but their signature aid voice stays humanitarian unless a scene needs them to break pattern. Brightstep prefers **shipping occlusion/weapons** over volunteering boarding actions.
...
- Schedulecap ↔ Closeglen (flare clocks vs mechanical clocks)  
- Rootward / Mycorr → Humans (“metal-poisoners”)  
- Moru / Glass-Barge textile-vs-shard snubs  
...
Directed voice lines for diplomacy and banter; Softnight collects gentle-pastime praise; invade Milknight and the roster objects; peaceful-nice send humanitarian lines, militaristic-nice send balance-of-power fleets.