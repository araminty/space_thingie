...
- Blind Spray’s fixed threshold (e.g. always Skew-8 / need 8+ on 2d6, or Spray maps to a need table without Δ) — pick when wiring.
...
**Hit odds by range** (Acc/Spray lanes): see [`arsenal-hit-tables.md`](arsenal-hit-tables.md).
